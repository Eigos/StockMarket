package com.stockmarket.sproject.application.exception_handler;
...
import com.stockmarket.sproject.application.exception_handler.api_error.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMessageExceptions(
        MessageException e){
            ApiError apiError = new ApiError(NOT_FOUND);
